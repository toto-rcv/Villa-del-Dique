...
export interface ApiDirectivoDirectivo extends Struct.CollectionTypeSchema {
  collectionName: 'directivos';
  info: {
    description: 'Miembros de la comisi\u00F3n directiva del club';
    displayName: 'Directivo';
    pluralName: 'directivos';
    singularName: 'directivo';
  };
  options: {
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Eventos no deportivos: biblioteca, talleres, jornadas solidarias';
    displayName: 'Evento';
    pluralName: 'eventos';
    singularName: 'evento';
  };
  ...
  attributes: {
    cartel: Schema.Attribute.Media<'images'>;
    ...
    link_inscripcion: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::evento.evento'
...
export interface ApiJugadorJugador extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jugadores de futbol y bochas';
    displayName: 'Jugador';
  ...
  attributes: {
    ...
    bio: Schema.Attribute.Text;
    capitan: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    categoria: Schema.Attribute.Enumeration<
      ['primera', 'reserva', 'inferiores', 'femenino', 'bochas']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'primera'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    edad: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    estado: Schema.Attribute.Enumeration<['titular', 'suplente', 'plantel']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'plantel'>;
    formacion_x: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
        ...
        number
      >;
    formacion_y: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    tipo: Schema.Attribute.Enumeration<['futbol', 'bochas']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'futbol'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Noticias y novedades del club';
    displayName: 'Noticia';
    pluralName: 'noticias';
...
export interface ApiPartidoPartido extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Fixture/partidos del club';
    displayName: 'Partido';
    pluralName: 'partidos';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Primera Masculino'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destacado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    estadio: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'programado'>;
    fecha: Schema.Attribute.DateTime & Schema.Attribute.Required;
    goles_local: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    goles_visitante: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    local: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    publishedAt: Schema.Attribute.DateTime;
    rival: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
    torneo: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSponsorSponsor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sponsors y auspiciantes del club';
    displayName: 'Sponsor';
    pluralName: 'sponsors';
  ...
  attributes: {
    activo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    categoria: Schema.Attribute.Enumeration<
      ['principal', 'secundario', 'apoyo']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'apoyo'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::directivo.directivo': ApiDirectivoDirectivo;
